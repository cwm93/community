 ...
 */
@Entity
@Table(name = "zf_appeal_analysis_content")
public class FAppealAnalysisContent implements Serializable {
	 ...
	 * 二、投诉热点问题TOP10
	 **/
	private FAppealAnalysis appealAnalysis;
	...
	@ManyToOne(targetEntity = FAppealAnalysis.class)  
	@JoinColumn(name="appeal_analysis_id",updatable=false) 
	public FAppealAnalysis getAppealAnalysis() {
		return appealAnalysis;
	}

	public void setAppealAnalysis(FAppealAnalysis appealAnalysis) {
		this.appealAnalysis = appealAnalysis;
	}
	...
	@Column(name = "top_06")
	public String getTop_06() {
		return top_06;
	}

	public void setTop_06(String top_06) {
		this.top_06 = top_06;
	}
