...
/**
 * @author liliang 通信管理局--实名制报表
 */
public class GRealNameRegistration implements Serializable {

	private static final long serialVersionUID = 1L;

	private Long id;
	// 电信
	private Float field_11;// 移动电话用户总量（万）
	private Float field_12;// 固定电话用户总量（万）
	private Float field_13;// 移动电话已登记用户数（万）
	private Float field_14;// 固定电话已登记用户数（万）
	private Float field_15;// 移动电话实名率
	private Float field_16;// 固定电话实名率
	private Float field_17;// 合规率
	// 移动
	private Float field_21;// 移动电话用户总量（万）
	private Float field_22;// 固定电话用户总量（万）
	private Float field_23;// 移动电话已登记用户数（万）
	private Float field_24;// 固定电话已登记用户数（万）
	private Float field_25;// 移动电话实名率
	private Float field_26;// 固定电话实名率
	private Float field_27;// 合规率
	// 联通
	private Float field_31;// 移动电话用户总量（万）
	private Float field_32;// 固定电话用户总量（万）
	private Float field_33;// 移动电话已登记用户数（万）
	private Float field_34;// 固定电话已登记用户数（万）
	private Float field_35;// 移动电话实名率
	private Float field_36;// 固定电话实名率
	private Float field_37;// 合规率

	private Integer year;// 年份
	private Integer month;// 月份
	
	private String sourceFrom;//默认：0：手动添加；1:系统自动获取；
