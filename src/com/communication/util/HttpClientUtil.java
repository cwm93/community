...
public class HttpClientUtil {
	...
	public static void main(String[] args) {
		...
		/*
		 * String Uid = "shcagov"; String Key = "49ab902a79d41993b8e7"; String content =
		 * "验证码：8888【上海市通信管理局】"; String mobiles = "13585511438"; int errorCode =
		 * httpClient.sendMsgUtf8(Uid, Key, content, mobiles);
		 * System.out.println(httpClient.getErrorMsg(errorCode));
		 */

		String url = "http://www.smschinese.cn/web_api/SMS/?Action=SMS_Num&Uid=shcagov&Key=49ab902a79d41993b8e7";
		System.out.println(httpClient.sendHttpGet(url));
	}
}