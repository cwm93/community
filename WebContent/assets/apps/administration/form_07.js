...
var queryJsonData = function (loadingYear){
	...
	$.ajax({
		...
		success : function(data) {
			layer.closeAll();
			if (data.gInternetPlatformSpamMessageList!=null&&data.gInternetPlatformSpamMessageList.length>0) {
				layer.msg('数据加载成功');
				$.each(data.gInternetPlatformSpamMessageList,function(index,entity){
					dataContent = dataContent + "<tr><td rowspan='3'><a href='javascript:void(0);' onclick='javascript:editData("+entity.id+");'>"+entity.year+"/"+entity.month+"</a></td><td>电信</td><td>"+converter(entity.field_11)+"</td><td>"+converter(entity.field_12)+"</td><td>"+converter(entity.field_13)+"%</td><td>"+converter(entity.field_14)+"</td><td>"+converter(entity.field_15)+"</td><td>"+converter(entity.field_16)+"</td><td>"+converter(entity.field_17)+"</td></tr>"+
					                            "<tr><td>移动</td><td>"+converter(entity.field_21)+"</td><td>"+converter(entity.field_22)+"</td><td>"+converter(entity.field_23)+"%</td><td>"+converter(entity.field_24)+"</td><td>"+converter(entity.field_25)+"</td><td>"+converter(entity.field_26)+"</td><td>"+converter(entity.field_27)+"</td></tr>"+
					                            "<tr><td>联通</td><td>"+converter(entity.field_31)+"</td><td>"+converter(entity.field_32)+"</td><td>"+converter(entity.field_33)+"%</td><td>"+converter(entity.field_34)+"</td><td>"+converter(entity.field_35)+"</td><td>"+converter(entity.field_36)+"</td><td>"+converter(entity.field_37)+"</td></tr>";
				})
...
function editData(id){
	$.get("/gj/ljdxjb/detail?id="+id,function(data,status){
		  ...
		  $('#field_27').val(data.entity.field_27);
		  ...
		  $('#field_37').val(data.entity.field_37);
		  $("#deleteBtn").show();
		  $('#add-form').modal('show');
