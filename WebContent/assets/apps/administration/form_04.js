...
var queryJsonData = function (loadingYear){
	...
	$.ajax({
		type : "get",
		url : "/gj/m_txxxzpjb/list",
		data : {year : loadingYear},
		dataType : "json",
		success : function(data) {
			layer.closeAll();
			if (data.mobileFraudReportList!=null&&data.mobileFraudReportList.length>0) {
				layer.msg('数据加载成功');
...
function editData(id){
	$.get("/gj//m_txxxzpjb/detail?id="+id,function(data,status){
