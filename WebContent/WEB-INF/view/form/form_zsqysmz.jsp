	...
	<div class="container">
		<div class="row">
			<div class="col-xs-12">
				...
				<form class="entry-form entry-form-bordered" name="form1" id="form1" method="post" action="/zsqysmz/save">
					...
					<div class="form-actions">
						<div class="row">
						  <div class="col-xs-12 text-center mt-checkbox-list" data-error-container="#form_accept_error" style="font-size:14px;margin:8px 0;">
								本人承诺以上申报数据真实有效，有据可查！<input type="checkbox" name="accept"/>
								<div id="form_accept_error"></div>
								<input type="hidden" name="reportLogId" value="${reportLog.id}"/>
								<input type="hidden" name="insertUserId" value="${curUser.id}"/><input
										type="hidden" name="telecomOperatorId" value="${curUser.telecomOperator.id}" />
								<input type="hidden" name="id" value="${fResaleRealNameRegistration.id}"/>
							</div>
