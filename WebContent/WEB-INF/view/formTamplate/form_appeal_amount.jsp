	...
	<div class="container">
		<div class="row">
			<div class="col-xs-12">
				...
				<h5 class="form-title">有效申诉量统计情况</h5>
				   ...
				   <div class="alert alert-warning"><a href="#" class="close" data-dismiss="alert">&times;</a>
					...
					<table class="entry-table table-bordered">
						...
						<tr>
							...
							<td class="text-center"><input type="text" class="form-control input-sm" name="field_01"></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td class="text-center" style="width:10%"><input type="text" class="form-control input-sm" name="field_01"></td>
						</tr>
						<tr>
