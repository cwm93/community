...
<body
				...
				<div class="page-content">
					...
					<div class="page-bar">
						<ul class="page-breadcrumb">
							<li>
								<h3 style="font-size: 16px; margin: 0; padding: 0;">管理处统计表（总表）</h3>
							</li>
						</ul>
					</div>
					<!-- END PAGE BAR -->
					...
					<div class="row">
						<div class="col-md-12">
							<h3 class="text-center" style="padding: 0; margin: 0; font-size: 14px; line-height: 32px;font-weight:900;">管理处统计表</h3>
							<div class="panel panel-default">
								<div class="panel-heading form-inline">
									...
									<button class="btn btn-primary" id="searchData">查询</button>
									<button class="btn btn-danger" id="downloadPDF"><i class="fa fa-download"></i> PDF</button>
								</div>
	...
	<script type="text/javascript" src="/assets/apps/data/summaryJson.js?v=20190725"></script>
	<script type="text/javascript" src="/assets/pages/scripts/jspdf.min.js"></script>
		 ...
		 $('#downloadPDF').click(function(){
			...
			html2canvas(document.getElementById("dataContent"), {
			        onrendered: function(canvas) {
			            ...
			            //输出保存命名为content的pdf
			            doc.save('管理处统计表_'+loadingYear+'年'+loadingMonth+'月.pdf');
			        },
			        background:"#fff"
			  }); 
		 })
