...
<body
						...
						<div class="col-md-12">
							...
							<div class="panel panel-default">
								<div class="panel-heading form-inline">
									...
									</select> <span style="padding: 0 15px;">月</span> <input type="hidden" id="reportId" value="${report.id}">
									<button class="btn blue" id="searchData">查询</button>
								</div>
								<div class="panel-body" id="dataContent">
									<div class="none-data"></div>
								</div>
								<button class="btn btn-primary btn-sm" onclick="AutomateExcel('export')">Export to Excel</button>
	...
	<script type="text/javascript" src="/assets/apps/data/hmzyJson.js?v=2"></script>
	<script type="text/javascript" src="/assets/pages/scripts/tablesToExcel.js?v=1"></script>
</body>
</html>