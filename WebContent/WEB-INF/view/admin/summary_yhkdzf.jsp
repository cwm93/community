...
<body
		...
		<div class="page-container">
			...
			<div class="page-content-wrapper">
				...
				<div class="page-content">
					...
					<div class="row">
						<div class="col-md-12">
							<h3 class="text-center" style="padding: 0; margin: 0; font-size: 14px; line-height: 32px;">${report.title}</h3>
	...
	<script type="text/javascript" src="/assets/apps/data/yhkdzfJson.js"></script>
</body>
</html>