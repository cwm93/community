...
<body
				...
				<div class="page-content">
					...
					<div class="page-bar">
						<ul class="page-breadcrumb">
							<li>
								<h3 style="font-size: 16px; margin: 0; padding: 0;">通讯信息诈骗举报（固定电话）</h3>
							</li>
						</ul>
					</div>
					<!-- END PAGE BAR -->
					...
					<div class="row">
						<div class="col-md-12" style="margin-top: 30px;">
						    <div id="containerGDDHBJB" style="min-width: 310px; height: 450px; margin: 20px auto"></div>
									...
									<table class="table table-striped table-bordered table-advance table-hover">
										<thead>
											<tr>
												...
												<td class="text-center">全国排名</td>
												<td class="text-center">被举报件次</td>
												<td class="text-center">举报率（件次/百万用户）</td>
											</tr>
										</thead>
				...
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
							...
							<h4 class="modal-title">通讯信息诈骗举报（固定电话）</h4>
						</div>
						<div class="modal-body">
							<form class="form-horizontal" name="form1" id="form1" role="form">
								...
								<div class="form-group">
									<label class="col-sm-4 control-label">全国排名</label>
									<div class="col-sm-8">
										<input type="text" class="form-control" name="field_11" id="field_11">
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-4 control-label">被举报件次</label>
									<div class="col-sm-8">
										<input type="text" class="form-control" name="field_12" id="field_12">
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-4 control-label">举报率（件次/百万用户）</label>
									<div class="col-sm-8">
	...
	<script type="text/javascript" src="/assets/apps/administration/form_05.js?version=20190822"></script>
</body>
</html>