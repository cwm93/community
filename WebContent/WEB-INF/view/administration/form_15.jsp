...
<body
				...
				<div class="page-content">
					...
					<div class="page-bar">
						<ul class="page-breadcrumb">
							<li>
								<h3 style="font-size: 16px; margin: 0; padding: 0;">行业卡管理</h3>
							</li>
						</ul>
					</div>
					<!-- END PAGE BAR -->
					...
					<div class="row">
						<div class="col-md-12" style="margin-top: 30px;">
						    <div id="containerHYK" style="min-width: 310px; height:450px; margin: 20px auto"></div>
									...
									<table class="table table-striped table-bordered table-advance table-hover">
										<thead>
											<tr>
												...
												<td class="text-center">存量物联网卡用户数（个）</td>
												<td class="text-center">累计采取技术限定号码数量</td>
												<td class="text-center">技术限定百分率</td>
											</tr>
										</thead>
				...
				<div class="modal-body">
					<form class="form-horizontal" name="form1" id="form1" role="form">
						...
						<div class="form-group" style="border-bottom: 1px solid #f0f0f0; font-size: 16px;">
							<label for="lastname" class="col-sm-4 control-label">电信</label>
						</div>
						<div class="form-group">
							<label class="col-sm-4 control-label">存量物联网卡用户数（个）</label>
							<div class="col-sm-8">
								<input type="text" class="form-control" name="field_11" id="field_11">
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-4 control-label">累计采取技术限定号码数量</label>
							<div class="col-sm-8">
								<input type="text" class="form-control" name="field_12" id="field_12">
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-4 control-label">技术限定百分率</label>
							<div class="col-sm-8">
								<div class="input-group">
									<input type="text" class="form-control" name="field_13" id="field_13" placeholder="100.00"><span class="input-group-addon">%</span>
								</div>
							</div>
						</div>
						<div class="form-group" style="border-bottom: 1px solid #f0f0f0; font-size: 16px;">
							<label for="lastname" class="col-sm-4 control-label">移动</label>
						</div>
						<div class="form-group">
							<label class="col-sm-4 control-label">存量物联网卡用户数（个）</label>
							<div class="col-sm-8">
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<div class="input-group">
									<input type="text" class="form-control" name="field_23" id="field_23" placeholder="100.00"><span class="input-group-addon">%</span>
								</div>
							</div>
						</div>
						<div class="form-group" style="border-bottom: 1px solid #f0f0f0; font-size: 16px;">
							<label for="lastname" class="col-sm-4 control-label">联通</label>
						</div>
						<div class="form-group">
							<label class="col-sm-4 control-label">存量物联网卡用户数（个）</label>
							<div class="col-sm-8">
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<div class="input-group">
									<input type="text" class="form-control" name="field_33" id="field_33" placeholder="100.00"><span class="input-group-addon">%</span>
								</div>
							</div>
						</div>
						<div class="form-group">
	...
	<script type="text/javascript" src="/assets/apps/administration/form_15.js?version=20190822"></script>
</body>
</html>