...
<body
				...
				<div class="page-content">
					...
					<div class="page-bar">
						<ul class="page-breadcrumb">
							<li>
								<h3 style="font-size: 16px; margin: 0; padding: 0;">虚拟运营商</h3>
							</li>
						</ul>
					</div>
					<!-- END PAGE BAR -->
					...
					<div class="row">
						<div class="col-md-12" style="margin-top: 30px;">
						    <div id="containerXNYYSZS" style="min-width: 310px; height:450px; margin: 20px auto"></div>
						    <div id="containerXNYYSXZ" style="min-width: 310px; height:450px; margin: 20px auto"></div>
						    <script type="text/javascript" src="/assets/apps/administration/hightchats_data.js"></script>
				...
				<div class="modal-body">
					<form class="form-horizontal" name="form1" id="form1" role="form">
						...
						<div class="form-group" style="border-bottom: 1px solid #f0f0f0; font-size: 16px;">
							<label for="lastname" class="col-sm-4 control-label">全国</label>
						</div>
						<div class="form-group">
							<label class="col-sm-4 control-label">用户总数（万）</label>
							<div class="col-sm-8">
								<input type="text" class="form-control" name="field_11" id="field_11">
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-4 control-label">本月新增数（万）</label>
							<div class="col-sm-8">
								<input type="text" class="form-control" name="field_12" id="field_12">
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-4 control-label">转售收入总数（万）</label>
							<div class="col-sm-8">
								<input type="text" class="form-control" name="field_13" id="field_13">
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-4 control-label">本月转售收入（万）</label>
							<div class="col-sm-8">
								<input type="text" class="form-control" name="field_14" id="field_14">
							</div>
						</div>
						<div class="form-group" style="border-bottom: 1px solid #f0f0f0; font-size: 16px;">
							<label for="lastname" class="col-sm-4 control-label">本地</label>
						</div>
						<div class="form-group">
							<label class="col-sm-4 control-label">用户总数（万）</label>
							<div class="col-sm-8">
	...
	<script type="text/javascript" src="/assets/apps/administration/form_14.js?version=20190822"></script>
</body>
</html>