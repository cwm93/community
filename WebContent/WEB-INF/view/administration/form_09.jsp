...
<body
				...
				<div class="page-content">
					...
					<div class="page-bar">
						<ul class="page-breadcrumb">
							<li>
								<h3 style="font-size: 16px; margin: 0; padding: 0;">宽带资费</h3>
							</li>
						</ul>
					</div>
					<!-- END PAGE BAR -->
					...
					<div class="row">
						<div class="col-md-12" style="margin-top: 30px;">
						    <div id="containerKDZF" style="min-width: 310px; height:450px; margin: 20px auto"></div>
									...
									<table class="table table-striped table-bordered table-advance table-hover">
										<thead>
											<tr>
												...
												<td class="text-center">总家庭用户数（万户）</td>
												<td class="text-center">总用户数（包含家庭用户、集客用户）（万户）</td>
												<td class="text-center">平均带宽（M）</td>
											</tr>
										</thead>
					...
					<div class="modal-content">
						...
						<div class="modal-body">
							<form class="form-horizontal" name="form1" id="form1" role="form">
								...
								<div class="form-group" style="border-bottom:1px solid #f0f0f0;font-size:16px;"><label for="lastname" class="col-sm-4 control-label">上海电信</label></div>
								<div class="form-group">
									<label class="col-sm-4 control-label">总家庭用户数（万户）</label>
									<div class="col-sm-8">
										<input type="text" class="form-control" name="field_11" id="field_11">
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-4 control-label">总用户数（包含家庭用户、集客用户）（万户）</label>
									<div class="col-sm-8">
										<input type="text" class="form-control" name="field_12" id="field_12">
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-4 control-label">平均带宽（M）</label>
									<div class="col-sm-8">
										<input type="text" class="form-control" name="field_13" id="field_13">
									</div>
								</div>
								<div class="form-group" style="border-bottom:1px solid #f0f0f0;font-size:16px;"><label for="lastname" class="col-sm-4 control-label">上海移动</label></div>
								<div class="form-group">
									<label class="col-sm-4 control-label">总家庭用户数（万户）</label>
									<div class="col-sm-8">
								...
								<div class="form-group" style="border-bottom:1px solid #f0f0f0;font-size:16px;"><label for="lastname" class="col-sm-4 control-label">上海联通</label></div>
								<div class="form-group">
									<label class="col-sm-4 control-label">总家庭用户数（万户）</label>
									<div class="col-sm-8">
								...
								<div class="form-group">
									...
									<div class="form-group" style="border-bottom:1px solid #f0f0f0;font-size:16px;"><label for="lastname" class="col-sm-4 control-label">长城宽带</label></div>
								<div class="form-group">
									<label class="col-sm-4 control-label">总家庭用户数（万户）</label>
									<div class="col-sm-8">
								...
								<div class="form-group">
									<label class="col-sm-4 control-label">总用户数（包含家庭用户、集客用户）（万户）</label>
									<div class="col-sm-8">
										<input type="text" class="form-control" name="field_42" id="field_42">
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-4 control-label">平均带宽（M）</label>
									...
									<div class="form-group" style="border-bottom:1px solid #f0f0f0;font-size:16px;"><label for="lastname" class="col-sm-4 control-label">东方有线</label></div>
								<div class="form-group">
									<label class="col-sm-4 control-label">总家庭用户数（万户）</label>
									<div class="col-sm-8">
								...
								<div class="form-group">
									<label class="col-sm-4 control-label">总用户数（包含家庭用户、集客用户）（万户）</label>
									<div class="col-sm-8">
										<input type="text" class="form-control" name="field_52" id="field_52">
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-4 control-label">平均带宽（M）</label>
									<div class="col-sm-8">
										<input type="text" class="form-control" name="field_53" id="field_53">
									</div>
								</div>
								<div class="form-group">
	...
	<script type="text/javascript" src="/assets/apps/administration/form_09.js?version=20190822"></script>
</body>
</html>