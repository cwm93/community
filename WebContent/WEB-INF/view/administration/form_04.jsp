...
<body
				...
				<div class="page-content">
					...
					<div class="page-bar">
						<ul class="page-breadcrumb">
							<li>
								<h3 style="font-size: 16px; margin: 0; padding: 0;">通讯信息诈骗举报（手机号）</h3>
							</li>
						</ul>
					</div>
					<!-- END PAGE BAR -->
					...
					<div class="row">
						<div class="col-md-12" style="margin-top: 30px;">
						    <div id="containerXXZP" style="min-width: 310px; height: 450px; margin: 20px auto"></div>
				...
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
							...
							<h4 class="modal-title">通讯信息诈骗举报（手机号）</h4>
						</div>
	...
	<script type="text/javascript" src="/assets/apps/administration/form_04.js?version=20190822"></script>
</body>
</html>