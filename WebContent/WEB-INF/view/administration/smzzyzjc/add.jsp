		...
		<div class="row">
			<div class="col-sm-12">
			   <h3 class="title">
				...
				<h5 class="form-title">实名志愿者监督检查-数据录入</h5>
				<form class="form-horizontal" name="form1" id="form1" role="form" action="/gj/smz/save" onsubmit="return checkForm();" enctype="multipart/form-data" method="post">
					...
					<div class="form-group">
						<label for="firstname" class="col-sm-4 control-label">基础电信企业门店数</label>
						<div class="col-sm-8">
					...
					<div class="form-group">
						<label for="lastname" class="col-sm-4 control-label">转售企业门店数（合规）</label>
						<div class="col-sm-8">
					...
					<div class="form-group">
						<label for="lastname" class="col-sm-4 control-label">检查人次</label>
						<div class="col-sm-8">
							<input type="text" class="form-control" id="lastname"
								placeholder="">
						</div>
