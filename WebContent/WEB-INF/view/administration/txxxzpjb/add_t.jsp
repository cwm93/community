		...
		<div class="row">
			<div class="col-sm-12">
			   <h3 class="title">
				...
				<h5 class="form-title">通讯信息诈骗举报（固定电话）-数据录入</h5>
				<form class="form-horizontal" name="form1" id="form1" role="form"
					action="/gj/smz/save" onsubmit="return checkForm();"
					...
					<div class="form-group">
						<label for="firstname" class="col-sm-4 control-label">排名</label>
						<div class="col-sm-8">
					...
					<div class="form-group">
						<label for="lastname" class="col-sm-4 control-label">被举报件次</label>
						<div class="col-sm-8">
					...
					<div class="form-group">
						<label for="lastname" class="col-sm-4 control-label">举报率（件次/百万用户）</label>
						<div class="col-sm-8">
							<input type="text" class="form-control" id="lastname"
								placeholder="">
						</div>
