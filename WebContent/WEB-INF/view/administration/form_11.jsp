...
<body
				...
				<div class="page-content">
					...
					<div class="page-bar">
						<ul class="page-breadcrumb">
							<li>
								<h3 style="font-size: 16px; margin: 0; padding: 0;">增值电信业务</h3>
							</li>
						</ul>
					</div>
					<!-- END PAGE BAR -->
					...
					<div class="row">
						<div class="col-md-12" style="margin-top: 30px;">
						    <div id="containerYYSR" style="min-width: 310px; height:450px; margin: 20px auto"></div>
						    <div id="containerSRFB" style="min-width: 310px; height:300px; margin: 20px auto"></div>
									...
									<table class="table table-striped table-bordered table-advance table-hover">
										<thead>
											<tr>
												...
												<td class="text-center">业务种类</td>
												<td class="text-center">营业收入（亿）</td>
												<td class="text-center">同比</td>
												<td class="text-center">电信业务收入（亿）</td>
												<td class="text-center">同比</td>
											</tr>
										</thead>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title">增值电信业务</h4>
				</div>
				<div class="modal-body">
					<form class="form-horizontal" name="form1" id="form1" role="form">
						...
						<div class="form-group" style="border-bottom: 1px solid #f0f0f0; font-size: 16px;">
							<label for="lastname" class="col-sm-4 control-label">总计</label>
						</div>
						<div class="form-group">
						...
						<div class="form-group" style="border-bottom: 1px solid #f0f0f0; font-size: 16px;">
							<label for="lastname" class="col-sm-4 control-label">信息服务</label>
						</div>
						<div class="form-group">
							<label class="col-sm-4 control-label">营业收入（亿）</label>
							<div class="col-sm-8">
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<div class="input-group">
									<input type="text" class="form-control" name="field_22" id="field_22" placeholder="100.00"><span class="input-group-addon">%</span>
								</div>
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<div class="input-group">
									<input type="text" class="form-control" name="field_24" id="field_24" placeholder="100.00"><span class="input-group-addon">%</span>
								</div>
							</div>
						</div>
						<div class="form-group" style="border-bottom: 1px solid #f0f0f0; font-size: 16px;">
							<label for="lastname" class="col-sm-4 control-label">接入服务</label>
						</div>
						<div class="form-group">
							<label class="col-sm-4 control-label">营业收入（亿）</label>
							<div class="col-sm-8">
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<div class="input-group">
									<input type="text" class="form-control" name="field_32" id="field_32" placeholder="100.00"><span class="input-group-addon">%</span>
								</div>
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<div class="input-group">
									<input type="text" class="form-control" name="field_34" id="field_34" placeholder="100.00"><span class="input-group-addon">%</span>
								</div>
							</div>
						</div>
						<div class="form-group" style="border-bottom: 1px solid #f0f0f0; font-size: 16px;">
							<label for="lastname" class="col-sm-4 control-label">呼叫中心</label>
						</div>
						<div class="form-group">
							<label class="col-sm-4 control-label">营业收入（亿）</label>
							<div class="col-sm-8">
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<div class="input-group">
									<input type="text" class="form-control" name="field_42" id="field_42" placeholder="100.00"><span class="input-group-addon">%</span>
								</div>
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<div class="input-group">
									<input type="text" class="form-control" name="field_44" id="field_44" placeholder="100.00"><span class="input-group-addon">%</span>
								</div>
							</div>
						</div>
						<div class="form-group">
	...
	<script type="text/javascript" src="/assets/apps/administration/form_11.js?version=20190822"></script>
</body>
</html>