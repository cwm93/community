...
<body
				...
				<div class="page-content">
					...
					<div class="page-bar">
						<ul class="page-breadcrumb">
							<li>
								<h3 style="font-size: 16px; margin: 0; padding: 0;">降费</h3>
							</li>
						</ul>
					</div>
					<!-- END PAGE BAR -->
					...
					<div class="row">
						<div class="col-md-12" style="margin-top: 30px;">
						    <div id="containerJF" style="min-width: 310px; height:450px; margin: 20px auto"></div>
									...
									<table class="table table-striped table-bordered table-advance table-hover">
										<thead>
											<tr>
												...
												<td class="text-center">固定宽带单位带宽平均资费（元/Mbps）</td>
												<td class="text-center">手机流量平均资费（元/MB）</td>
											</tr>
										</thead>
					...
					<div class="modal-content">
						...
						<div class="modal-body">
							<form class="form-horizontal" name="form1" id="form1" role="form">
								...
								<div class="form-group">
									<label class="col-sm-4 control-label">固定宽带单位带宽平均资费（元/Mbps）</label>
									<div class="col-sm-8">
										<input type="text" class="form-control" name="field_11" id="field_11">
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-4 control-label">手机流量平均资费（元/MB）</label>
									<div class="col-sm-8">
	...
	<script type="text/javascript" src="/assets/apps/administration/form_10.js?version=20190822"></script>
</body>
</html>