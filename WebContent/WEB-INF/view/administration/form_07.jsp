...
<body
				...
				<div class="page-content">
					...
					<div class="page-bar">
						<ul class="page-breadcrumb">
							<li>
								<h3 style="font-size: 16px; margin: 0; padding: 0;">网间平台垃圾短信举报</h3>
							</li>
						</ul>
					</div>
					<!-- END PAGE BAR -->
					...
					<div class="row">
						<div class="col-md-12" style="margin-top: 30px;">
						    <div id="containerWJLJDXJB" style="min-width: 310px; height:450px; margin: 20px auto"></div>
				...
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
							...
							<h4 class="modal-title">网间平台垃圾短信举报</h4>
						</div>
						<div class="modal-body">
							<form class="form-horizontal" name="form1" id="form1" role="form">
								...
								<div class="form-group">
									<label class="col-sm-4 control-label">排名（集团/全国）</label>
									<div class="col-sm-8">
										<input type="text" class="form-control" name="field_11" id="field_11">
									</div>
								</div>
							    <div class="form-group">
									<label class="col-sm-4 control-label">被举报率（件次/千万用户）</label>
									<div class="col-sm-8">
										<input type="text" class="form-control" name="field_12" id="field_12">
									</div>
							   </div>
							   	<div class="form-group">
									<label class="col-sm-4 control-label">增幅（%）</label>
									<div class="col-sm-8">
										<div class="input-group"><input type="text" class="form-control" name="field_13" id="field_13" placeholder="100.00"><span class="input-group-addon">%</span> </div>
										<span class="help-block">百分制，请不要填写"%"</span>
									</div>
								</div>
								 <div class="form-group">
									<label class="col-sm-4 control-label">“0000”退订</label>
									<div class="col-sm-8">
										<input type="text" class="form-control" name="field_14" id="field_14">
									</div>
							    </div>
							    <div class="form-group">
									<label class="col-sm-4 control-label">收到垃圾短信息投诉量（起）</label>
									<div class="col-sm-8">
										<input type="text" class="form-control" name="field_15" id="field_15">
									</div>
							    </div>
							    <div class="form-group">
									<label class="col-sm-4 control-label">处理完毕（起）</label>
									<div class="col-sm-8">
										<input type="text" class="form-control" name="field_16" id="field_16">
									</div>
							    </div>
							    <div class="form-group">
									<label class="col-sm-4 control-label">拦截垃圾短信息总量（万条）</label>
									<div class="col-sm-8">
							    ...
							    <div class="form-group">
							   	...
							   	<div class="form-group">
									<label class="col-sm-4 control-label">增幅（%）</label>
									<div class="col-sm-8">
										<div class="input-group"><input type="text" class="form-control" name="field_23" id="field_23" placeholder="100.00"><span class="input-group-addon">%</span> </div>
										<span class="help-block">百分制，请不要填写"%"</span>
									</div>
								</div>
								 <div class="form-group">
							    ...
							    <div class="form-group">
									<label class="col-sm-4 control-label">拦截垃圾短信息总量（万条）</label>
									<div class="col-sm-8">
										<input type="text" class="form-control" name="field_27" id="field_27">
									</div>
							    </div>
							    ...
							    <div class="form-group">
							   	...
							   	<div class="form-group">
									<label class="col-sm-4 control-label">增幅（%）</label>
									<div class="col-sm-8">
										<div class="input-group"><input type="text" class="form-control" name="field_33" id="field_33" placeholder="100.00"><span class="input-group-addon">%</span> </div>
										<span class="help-block">百分制，请不要填写"%"</span>
									</div>
								</div>
								 <div class="form-group">
							    ...
							    <div class="form-group">
									<label class="col-sm-4 control-label">拦截垃圾短信息总量（万条）</label>
									<div class="col-sm-8">
										<input type="text" class="form-control" name="field_37" id="field_37">
									</div>
							    </div>
								<div class="form-group">
	...
	<script type="text/javascript" src="/assets/apps/administration/form_07.js?version=20190822"></script>
</body>
</html>