...
<body
				...
				<div class="page-content">
					...
					<div class="page-bar">
						<ul class="page-breadcrumb">
							<li>
								<h3 style="font-size: 16px; margin: 0; padding: 0;">本地移动通信转售企业业务统计表</h3>
							</li>
						</ul>
					</div>
					<!-- END PAGE BAR -->
						...
						<div class="col-md-12" style="margin-top: 30px;">
						   <div class="panel panel-default">
								<div class="panel-heading">
								    <div id="form18_1" style="min-width: 310px; height:450px; margin: 20px auto"></div>
								    <div id="form18_2" style="min-width: 310px; height:450px; margin: 20px auto"></div>
								...
								<div class="panel-body">
									<table class="table table-striped table-bordered table-advance table-hover">
										<thead>
											<tr>
												<td class="text-center" style="height:90px;width:80px;">月份</td>
												<td class="text-center">移动电话用户数量（户）</td>
												<td class="text-center">单位用户数量（户）</td>
												<td class="text-center">行业应用卡数量（户）</td>
												<td class="text-center">一证多户号码数</td>
												<td class="text-center">一证多卡用户数</td>
												<td class="text-center">转售业务收入（万元）</td>
												<td class="text-center">实体代理店数</td>
												<td class="text-center">网络代理店数</td>
												<td class="text-center">社会渠道统一配发授权牌数量（张）</td>
												<td class="text-center">统计月检查次数</td>
												<td class="text-center">本年度累计检查次数</td>
												<td class="text-center">本年度累计处罚和取消代理网点数</td>
												<td class="text-center">本年度累计处罚人员数</td>
											</tr>
										</thead>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title">本地移动通信转售企业业务统计表</h4>
				</div>
				<div class="modal-body">
					<form class="form-horizontal" name="form1" id="form1" role="form">
						...
						<div class="form-group">
							<label class="col-sm-4 control-label">移动电话用户数量（户）</label>
							<div class="col-sm-8">
								<input type="text" class="form-control" name="field_11" id="field_11">
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-4 control-label">单位用户数量（户）</label>
							<div class="col-sm-8">
								<input type="text" class="form-control" name="field_12" id="field_12">
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-4 control-label">行业应用卡数量（户）</label>
							<div class="col-sm-8">
								<input type="text" class="form-control" name="field_13" id="field_13">
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-4 control-label">一证多户号码数</label>
							<div class="col-sm-8">
								<input type="text" class="form-control" name="field_14" id="field_14">
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-4 control-label">一证多卡用户数</label>
							<div class="col-sm-8">
								<input type="text" class="form-control" name="field_15" id="field_15">
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-4 control-label">转售业务收入（万元）</label>
							<div class="col-sm-8">
								<input type="text" class="form-control" name="field_16" id="field_16">
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-4 control-label">实体代理店数</label>
							<div class="col-sm-8">
								<input type="text" class="form-control" name="field_17" id="field_17">
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-4 control-label">网络代理店数</label>
							<div class="col-sm-8">
								<input type="text" class="form-control" name="field_23" id="field_23">
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-4 control-label">社会渠道统一配发授权牌数量（张）</label>
							<div class="col-sm-8">
								<input type="text" class="form-control" name="field_18" id="field_18">
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-4 control-label">统计月检查次数</label>
							<div class="col-sm-8">
								<input type="text" class="form-control" name="field_19" id="field_19">
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-4 control-label">本年度累计检查次数</label>
							<div class="col-sm-8">
								<input type="text" class="form-control" name="field_20" id="field_20">
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-4 control-label">本年度累计处罚和取消代理网点数</label>
							<div class="col-sm-8">
								<input type="text" class="form-control" name="field_21" id="field_21">
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-4 control-label">本年度累计处罚人员数</label>
							<div class="col-sm-8">
	...
	<script type="text/javascript" src="/assets/apps/administration/form_18.js?version=20190822"></script>
</body>
</html>