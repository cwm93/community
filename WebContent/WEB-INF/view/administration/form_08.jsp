...
<body
				...
				<div class="page-content">
					...
					<div class="page-bar">
						<ul class="page-breadcrumb">
							<li>
								<h3 style="font-size: 16px; margin: 0; padding: 0;">固网码号资源</h3>
							</li>
						</ul>
					</div>
					<!-- END PAGE BAR -->
					...
					<div class="row">
						<div class="col-md-12" style="margin-top: 30px;">
						    <div id="containerGWHMZY" style="min-width: 310px; height:450px; margin: 20px auto"></div>
									...
									<table class="table table-striped table-bordered table-advance table-hover">
										<thead>
											<tr>
												...
												<td class="text-center">局号数（万）</td>
												<td class="text-center">号码使用率</td>
											</tr>
										</thead>
				...
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
							...
							<h4 class="modal-title">固网码号资源</h4>
						</div>
						<div class="modal-body">
							<form class="form-horizontal" name="form1" id="form1" role="form">
								...
								<div class="form-group">
									<label for="field_11" class="col-sm-4 control-label">局号数（万）</label>
									<div class="col-sm-8">
										<input type="text" class="form-control" name="field_11" id="field_11">
									</div>
								</div>
								<div class="form-group">
									<label for="field_12" class="col-sm-4 control-label">号码使用率</label>
									<div class="col-sm-8">
								...
								<div class="form-group" style="border-bottom:1px solid #f0f0f0;font-size:16px;"><label for="lastname" class="col-sm-4 control-label">移动（铁通）</label></div>
								<div class="form-group">
									<label for="field_21" class="col-sm-4 control-label">局号数（万）</label>
									<div class="col-sm-8">
										<input type="text" class="form-control" name="field_21" id="field_21">
									</div>
								</div>
								<div class="form-group">
									<label for="field_22" class="col-sm-4 control-label">号码使用率</label>
									<div class="col-sm-8">
								...
								<div class="form-group">
									<label for="field_31" class="col-sm-4 control-label">局号数（万）</label>
									<div class="col-sm-8">
										<input type="text" class="form-control" name="field_31" id="field_31">
									</div>
								</div>
								<div class="form-group">
									<label for="field_32" class="col-sm-4 control-label">号码使用率</label>
									<div class="col-sm-8">
	...
	<script type="text/javascript" src="/assets/apps/administration/form_08.js?version=20190822"></script>
</body>
</html>